...
func (l *RecurringDeleteLogic) RecurringDelete(req *types.RecurringDeleteReq) (*types.RecurringDeleteResp, error) {
	...
	if err != nil {
		if err == model.ErrNotFound {
			return nil, errcode.NotFound.Msgr("周期性记账规则不存在")
		}
		return nil, errcode.DBError.Msgr("查询周期性记账规则失败")
	}
	...
	if err != nil {
		...
		return nil, errcode.DBError.Msgr("删除周期性记账规则失败")
	}

	return &types.RecurringDeleteResp{}, nil
}
