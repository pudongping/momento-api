...
var (
	...
	tagsRowsExpectAutoSet   = strings.Join(stringx.Remove(tagsFieldNames, "`tag_id`"), ",")
	tagsRowsWithPlaceHolder = strings.Join(stringx.Remove(tagsFieldNames, "`tag_id`"), "=?,") + "=?"
)
...
type (
	tagsModel interface {
		...
		FindOneByQuery(ctx context.Context, rowBuilder squirrel.SelectBuilder) (*Tags, error)
		FindAll(ctx context.Context, rowBuilder squirrel.SelectBuilder) ([]*Tags, error)
		FindListByPage(ctx context.Context, rowBuilder squirrel.SelectBuilder, page, perPage int64, orderBy string) ([]*Tags, *paginator.Pagination, error)
		// 自定义模版中扩展的方法 end ---->
...
func (m *defaultTagsModel) Insert(ctx context.Context, data *Tags) (sql.Result, error) {
	...
	ret, err := m.conn.ExecCtx(ctx, query, data.UserId, data.Name, data.Color, data.Icon, data.IsSystem, data.Type, data.SortNum, data.CreatedAt, data.UpdatedAt)
	return ret, err
}

// 自定义模版中扩展的方法 start ----->

func (m *defaultTagsModel) GetTableName() string {
	return m.tableName()
}

func (m *defaultTagsModel) Transaction(ctx context.Context, fn func(ctx context.Context, session sqlx.Session) error) error {
...
func (m *defaultTagsModel) ExecContext(ctx context.Context, session sqlx.Session, query string, args ...interface{}) (sql.Result, error) {
	if session != nil {
...
func (m *defaultTagsModel) InsertWithSession(ctx context.Context, session sqlx.Session, insertData map[string]interface{}) (sql.Result, error) {
...
func (m *defaultTagsModel) DeleteFilter(ctx context.Context, session sqlx.Session, where squirrel.Sqlizer) (sql.Result, error) {
...
func (m *defaultTagsModel) UpdateFilter(ctx context.Context, session sqlx.Session, updateData map[string]interface{}, where squirrel.Sqlizer) (sql.Result, error) {
...
func (m *defaultTagsModel) SelectBuilder(fields ...string) squirrel.SelectBuilder {
	f := tagsRows
	if len(fields) > 0 {
...
func (m *defaultTagsModel) CountBuilder(field ...string) squirrel.SelectBuilder {
	f := "*"
...
func (m *defaultTagsModel) SumBuilder(field string) squirrel.SelectBuilder {
	return squirrel.Select("IFNULL(SUM(" + field + "),0)").From(m.table)
}

func (m *defaultTagsModel) FindCount(ctx context.Context, countBuilder squirrel.SelectBuilder) (int64, error) {
...
func (m *defaultTagsModel) FindSum(ctx context.Context, sumBuilder squirrel.SelectBuilder) (float64, error) {
...
func (m *defaultTagsModel) FindAny(ctx context.Context, rowBuilder squirrel.SelectBuilder, bindings interface{}) error {
...
func (m *defaultTagsModel) FindOneByQuery(ctx context.Context, rowBuilder squirrel.SelectBuilder) (*Tags, error) {
	query, values, err := rowBuilder.ToSql()
	if err != nil {
		return nil, err
	}
...
func (m *defaultTagsModel) FindAll(ctx context.Context, rowBuilder squirrel.SelectBuilder) ([]*Tags, error) {
	query, values, err := rowBuilder.ToSql()
	if err != nil {
		return nil, err
	}
...
func (m *defaultTagsModel) FindListByPage(ctx context.Context, rowBuilder squirrel.SelectBuilder, page, perPage int64, orderBy string) ([]*Tags, *paginator.Pagination, error) {
	// 构建查询数据总条数的 sql 语句
...
func (m *defaultTagsModel) Update(ctx context.Context, data *Tags) error {
	...
	_, err := m.conn.ExecCtx(ctx, query, data.UserId, data.Name, data.Color, data.Icon, data.IsSystem, data.Type, data.SortNum, data.CreatedAt, data.UpdatedAt, data.TagId)
	return err
}
